...
from handling_juxian import handle_juxian
import datetime
import time
import logging
...
def test_juxian():
	...
	:return:
	"""
	src_conn = connect(database="shichang_resume", collection="2014_juxian", host="192.168.3.224", port=27017)
	dest_conn = connect(database="2014", collection="juxian_resume", host="192.168.3.224", port=27017)
	# dest_conn = connect(database="resume_with_contact", collection="juxian_resume", host="101.204.243.241", port=27017)
	page = 0
